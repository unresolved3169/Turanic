...
class TimeCommand extends VanillaCommand {
	...
	public function __construct($name){
        ...
        $this->getOverload("default")->setParameter(0, new CommandParameter("args", CommandParameter::TYPE_STRING, false, CommandParameter::FLAG_VALID, CommandEnum::TYPE_CUSTOM, ["start", "stop", "query", "set", "add"]));
        $this->getOverload("default")->setParameter(1, new CommandParameter("time", CommandParameter::TYPE_MIXED, true, CommandParameter::FLAG_VALID, CommandEnum::TYPE_CUSTOM, ["day", "night"]));
	}
