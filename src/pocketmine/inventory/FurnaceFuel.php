...
abstract class FurnaceFuel{
	
	protected static $fuelTimes = [
		Item::COAL => 1600,
	...
	public static function getFurnaceFuelTime(int $itemId) : int{
		return self::$fuelTimes[$itemId] ?? 0;
	}
	
	public static function setFurnaceFuelTime(int $itemId, int $time){
		self::$fuelTimes[$itemId] = $time;
	}
